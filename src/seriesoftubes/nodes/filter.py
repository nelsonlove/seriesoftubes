...
from seriesoftubes.models import FilterNodeConfig, Node
        ...
        try:
                ...
                if split_item_name and split_item_name in template_data:
                    ...
                    try:
                        ...
                        return NodeResult(
                            output=None,
                            success=False,
                            error=f"Filter condition evaluation failed: {e!s}",
                        )
            ...
            try:
                ...
                return NodeResult(
                    output=None,
                    success=False,
                    error=f"Invalid condition template: {e!s}",
                )
            ...
            return NodeResult(
                output=None,
                success=False,
                error=f"Filter node execution failed: {e!s}",
            )
