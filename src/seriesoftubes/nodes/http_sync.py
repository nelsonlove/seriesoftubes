"""Synchronous HTTP node executor for Celery context"""
...
class SyncHTTPNodeExecutor(NodeExecutor):
    """Synchronous executor for HTTP nodes - for use in Celery workers"""
    ...
    async def execute(self, node: Node, context: NodeContext) -> NodeResult:
        """Execute an HTTP node using synchronous requests"""
        ...
        try:
            ...
            # Use synchronous httpx client to avoid event loop issues
