...
if __name__ == "__main__":
    ...
    async def manual_test():
        ...
        print("Testing basic execution status...")
        await test_instance.test_basic_execution_status()
        print("✓ Basic execution test passed")
        
        print("Testing database progress tracking engine import...")
        test_instance.test_database_progress_tracking_engine_import()
        print("✓ DatabaseProgressTrackingEngine import test passed")
        
        print("Testing multi-node execution...")
        await test_instance.test_multi_node_execution()
        print("✓ Multi-node execution test passed")
