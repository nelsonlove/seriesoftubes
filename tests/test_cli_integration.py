...
from seriesoftubes.cli_client import APIClient
...
def test_auth_status_not_authenticated():
    ...
    from seriesoftubes.cli_client import CLIConfig
    
    with patch("seriesoftubes.cli_client.get_cli_config") as mock_config:
...
def test_parse_input_args():
    ...
    from seriesoftubes.cli import parse_input_args
